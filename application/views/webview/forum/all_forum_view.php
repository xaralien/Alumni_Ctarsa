            ...
            <div class="col-lg-12 d-flex justify-content-start subheader-container">
                <div class="col-lg-4 profile-forum">
                    ...
                    foreach ($profileava as $pea) { ?>
                        ...
                        <?php } else { ?>
                            <div class="profile-picture d-flex justify-content-center">
                                <img class="img-fluid profile-image" src="<?php echo $this->ppaatthh . 'user_avatar/' . $pea->avatar ?>">
                            </div>
                        <?php } ?>
                ...
                <div class="col-lg-9 mt-3">
                    ...
                    <div class="card-forum-topic">
                        <?php foreach ($threads as $th) {
                            $this->db->select(' COUNT(id_thread) as countrep ');
                        ...
                        ?>
                            <a href="<?php echo site_url('forum/detail/' . $th->id) ?>">
                                <div class="card-topic mb-5">
                                    <div class="card-topic-profile d-flex justify-content-between">

                                        <?php if ($th->avatar == null || $th->avatar == "") { ?> <div class="profile-user">
                                        ...
                                        <?php } else { ?>
                                            <div class="profile-user">
                                                <img class="img-fluid topic-profile" src="<?php echo $this->ppaatthh . 'user_avatar/' . $th->avatar ?>">
                                                <div class="info-profile">
                                                    <h6><?php echo $th->full_name; ?></h6>
                                                    <p>Alumni <?php echo $th->year_graduate; ?></p>
                                                </div>
                                        ...
                                        <div class="card-desc-topic">
                                            <?php
                                            list($date, $time) = explode(" ", $th->created);
                                    ...
                                    <div class="card-action-topic">
                                        ...
                                        <div class="topic-reply">
                                            <a>
                                                ...
                                                <p><?php echo $countrep + $countrepchild; ?></p>
                                                <p>Replies</p>
                                            </a>
                                        </div>
                                    </div>

...
<script>
    ...
    function short_n() {
        ...
        if (uri == 'newest_section') {
            url = "<?php echo site_url('information/newest_section?sh_n=') ?>" + value,
                window.location = url;
        } else if (uri == 'newest_search') {
            if (val_tp == 'All') {
                url = "<?php echo site_url('information/newest_search?st_n=') ?>" + val_st,
                    window.location = url;
            } else {
                url = "<?php echo site_url('information/newest_search?st_n=') ?>" + val_st + '&cat_n=' + val_tp + '&sh_n=' + value, //accommodate search and sort category
                    window.location = url;
            }
        } else if (uri == 'newest_type') {
            if (val_tp == 'All') {
                url = "<?php echo site_url('information/newest_type?sh_n=') ?>" + value,
                    window.location = url;
            } else {
                url = "<?php echo site_url('information/newest_type?sh_n=') ?>" + value + '&cat_n=' + val_tp, //accommodate search and sort category
                    window.location = url;
            }
        } else {
            if (uri == 'newest_type') {
                ...
                url = "<?php echo site_url('information/newest_type?cat_n=') ?>" + val_tp,
                    window.location = url;
            }

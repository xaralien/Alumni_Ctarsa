...
class Autentic extends CI_Controller
{
  ...
  public function signup()
  {
    ...
    if ($nisn_r == $this->input->post('nisn')) {
      $data = array("status" => 'NISN Sudah Dipakai');
      ...
      if ($this->form_validation->run() === TRUE) {
        ...
        $config['smtp_user']     = "adib.dwikusuma12@gmail.com";
        $config['smtp_pass']     = "jmfddjefdrfwcrmi";#uhxirjcvsipwmkty
        ...
        $this->email->from('adib.dwikusuma12@gmail.com', 'TES KONFIRMASI');
        ...
        $data = array('status' => 'false', 'info' => validation_errors());
        echo json_encode($data);
      }
    }
  }
